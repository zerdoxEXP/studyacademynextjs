...
const features = [
  ...
  },
  {
    name: 'Schüler*innen',
    description:
      'Perfekt für Schüler*innen, die nach effektiven Wegen suchen, Lerninhalte leichter und nachhaltiger zu verstehen und zu behalten.',
    icon: HomeIcon,
  },
  {
    ...
    <div className="py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          Was ist die beste Zielgruppe?
          </h2>
          <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">
          Unsere Produkte sind für eine große Zielgruppe geeignet und lösen Probleme die viele kennen. Am besten geeignet sind sie für folgende Gruppen:
          </p>
        </div>
