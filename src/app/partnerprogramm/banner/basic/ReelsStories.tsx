...
export default function ReelsStories() {
  return (
    <div className="mt-8 container mx-auto px-4">
      <main className="grid grid-cols-5 gap-8">
        <div className="col-span-2 p-4">
          <h1 className="text-3xl font-bold dark:text-white">Instagram Reels/Stories</h1>
        ...
        <div className="col-span-3 flex justify-between gap-4">
          <img src="/images/partner/Banner/test-banner.jpg" alt="Banner 1" className="aspect-video w-1/3" />
          <img src="/images/partner/Banner/test-banner.jpg" alt="Banner 2" className="aspect-video w-1/3" />
          <img src="/images/partner/Banner/test-banner.jpg" alt="Banner 3" className="aspect-video w-1/3" />
        </div>
      </main>
    </div>
  );
