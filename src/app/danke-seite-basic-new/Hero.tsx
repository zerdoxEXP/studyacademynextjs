    ...
    return (
      <div className="px-6 pt-24 sm:pt-32 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          <p className="font-caveat text-2xl sm:text-4xl font-medium leading-7 text-blue-600 dark:text-blue-500">Glückwunsch, alles hat geklappt!</p>
        ...
        <div className="ml-3">
          <p className="text-base text-blue-600 dark:text-blue-500">Hinweis: Die Abbuchung erfolgt durch Copecart.</p>
        </div>
      </div>
