    ...
    <section id="CommunityFragen">
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl sm:pt-8 lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
            ...
            <h1><span className="font-caveat text-red-600 font-medium text-4xl mb-2">Last Minute </span><span className="max-w-2xl text-xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-2xl lg:col-span-2 xl:col-auto"> Lernplan - 100% kostenlos</span></h1>
