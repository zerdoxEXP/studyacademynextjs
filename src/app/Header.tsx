...
export default function Header() {
  ...
  return (
    <header className={`inset-x-0 top-0 z-40 fixed ${scrollPosition > 0 ? 'backdrop-blur-lg bg-white bg-opacity-80 dark:bg-gray-900 dark:bg-opacity-90 dark:border-transparent-white border-b border-gray-900/10 dark:border-white/10 border-opacity-40' : ''}`}>
