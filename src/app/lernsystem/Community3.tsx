        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-8 sm:gap-y-10 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:ml-auto lg:pl-4 lg:pt-4">
            <div className="lg:max-w-lg">
              <h3 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">Zugriff von überall</h3>
              <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">
              Du kannst auf alle Lektionen und den Study Academy Community Bereich mit allen möglichen Geräten zugreifen.
              </p>
          ...
          <div className="flex items-start justify-end lg:order-first">
            <Image
              src="/images/mockup-kurs-pro-plus-light.jpg"
              alt="Lernsystem Pro Devices"
              className="block dark:hidden"
              width={2432}
              height={1442}
            />
            <Image
              src="/images/mockup-kurs-pro-plus-dark.jpg"
              alt="Lernsystem Pro Devices"
