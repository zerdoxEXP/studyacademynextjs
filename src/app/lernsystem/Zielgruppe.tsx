...
const features = [
  {
    ...
    description:
      'Du möchtest deine Lernfähigkeiten verbessern, Prüfungen mit Zuversicht bestehen und weniger Stress.',
    icon: CheckBadgeIcon,
  },
  {
    name: 'Für die Schule',
    description:
      'Perfekt für alle, die ihre Noten in kurzer Zeit verbessern und einen guten Abschluss schaffen möchten.',
    icon: CheckBadgeIcon,
  },
  {
    name: 'Für berufliche Weiterbildung',
    description:
      'Wenn du viele Verpflichtungen hast und die Zeit die du zum Lernen hast, möglichst effektiv nutzen möchtest.',
    icon: CheckBadgeIcon,
  },
  {
