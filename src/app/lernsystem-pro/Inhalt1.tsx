export default function Inhalt1() {
    ...
    <div className="mx-auto max-w-md text-center py-14">
      ...
      >
        <p className="mt-2 block text-4xl font-semibold text-gray-900 dark:text-white">Alle Lektionen des Lernsystem <span className="font-caveat text-5xl text-blue-600 dark:text-blue-500">Basic</span></p>
      </div>
