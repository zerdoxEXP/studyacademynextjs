    ...
    <div className="isolate overflow-hidden dark:bg-gray-900">
      <div className="mx-auto max-w-7xl px-6 pb-96 pt-24 text-center sm:pt-32 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <h2 className="font-caveat text-4xl font-semibold leading-7 text-teal-600">Preise</h2>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
              {tiers.map((tier) => (
                ...
                >
                  <div>
                    <h3 id={tier.id} className="text-base font-semibold leading-7 text-teal-600">
                      {tier.name}
                    </h3>
